...
import { usePostPurchaseMutation } from '../../services/api'
...
const Checkout = () => {
  ...
  const [purchase, { data, isSuccess, isLoading }] = usePostPurchaseMutation()
  ...
  const form = useFormik({
    ...
    validationSchema: Yup.object({
      fullName: Yup.string()
        .min(5, 'O nome deve possuir pelo menos 5 letras')
                      ...
                      <S.InputGroup maxWidth="150px">
                        ...
                        >
                          {installments.map((installment) => (
                            ...
                            >{`${installment.quantity}x de ${installment.formattedAmount}`}</option>
                          ))}
                        </select>
                      </S.InputGroup>
                    </S.Row>
